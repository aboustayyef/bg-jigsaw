<x-partials.bg-section>
  ...
  <div class="justify-between md:grid md:grid-cols-3 md:gap-8">
    <x-partials.collection-item destination="/collection/home" title="Home Furniture" img="/assets/images/collection_ditre.jpeg">
    ...
    <x-partials.collection-item destination="/collection/office" title="Office Furniture" img="/assets/images/collection_interstuhl.jpeg">
    ...
    <x-partials.collection-item destination="/collection/accessories" title="Accessories" img="/assets/images/collection_accessories.jpeg">
