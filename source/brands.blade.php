...
---
@section('body')
    <x-partials.ui.list-item url="http://www.interstuhl.com/I/ia-en/index.php" title="Interstuhl" img="/assets/images/brands_interstuhl.jpg">
        Interstuhl is an independent, owner-run family company in Germany.
    </x-partials.ui.list-item>
    <x-partials.ui.list-item url="http://www.ditreitalia.com/" title="Ditre Italia" img="/assets/images/brands_ditre.jpg">
    ...
    <x-partials.ui.list-item url="http://www.aranworld.it/" title="Newform" img="/assets/images/brands_newform.jpg">
    ...
    <x-partials.ui.list-item url="http://kostaboda.com/" title="Kosta Boda" img="/assets/images/brands_kostaboda.jpg">
